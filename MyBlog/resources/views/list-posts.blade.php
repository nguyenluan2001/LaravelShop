            ...
            <div class="section" id="list-blog-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        ...
                        <li class="clearfix">
                            <a href="{{route('blog.detail',$item->id)}}" title="" class="thumb fl-left">
                                <img class="w-100" src="{{url('public/uploads/post/'.$item->post_img)}}" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="{{route('blog.detail',$item->id)}}" title="" class="title">{{$item->post_title}}</a>
