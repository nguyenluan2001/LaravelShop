        ...
        <div class="main-content fl-right">
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    ...
                    <div class="filter-wp fl-right">
                        ...
                        <div class="form-filter">
                            @isset($cat_id)
                            <form method="GET" action="{{route('product.filter',[$cat_id,$subcat_id])}}">
                                @csrf
                                <select name="filter">
                ...
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        @if(session('product_filter'))
                        @php $list_products=session('product_filter');@endphp
                        @endif
            ...
            <div class="section" id="paging-wp">
                @if(session('product_filter'))
               {{session('product_filter')->appends(['filter'=>session('filter')])->links()}}
                @else
                {{$list_products->links()}}
