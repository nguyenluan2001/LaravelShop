    ...
    <div class="row">
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.product.subcat.edit_process',$subcat->id)}}" method="post">
                        @csrf
                        <div class="form-group">
                            <label for="name">Tên danh mục</label>
                            <input class="form-control" type="text" name="title" id="name" value="{{$subcat->product_sub_cat_title}}">
                        </div>
