$(document).ready(function () {
    $('#site #container #main-content-wp #wrapper #cart tbody tr td input').change(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $(this).val(data.qty)
                $('#subtotal_' + rowid).text(data.subtotal)
    ...
    $('#site #container .checkout-page #wrapper #province ').change(function () {
        var id = $(this).val();
        var data={id:id}
         $.ajax({
     headers: {
        ...
        'url':'cart/district_ajax',
        'method':"post",
        'data':data,
        success:function(data)
        {
           $('#site #container .checkout-page #wrapper #district').html(data)
        },
        error:function(xhr,ajaxOptions,thrownError){
            alert(xhr.status)
            alert(thrownError)
    ...
    $('#site #container .checkout-page #wrapper #district ').change(function () {
        var id = $(this).val();
        var data={id:id}
         $.ajax({
     headers: {
        ...
        success:function(data)
        {
           $('#site #container .checkout-page #wrapper #ward').html(data)
        },
        error:function(xhr,ajaxOptions,thrownError){
            alert(xhr.status)
            alert(thrownError)
    ...
    $('#site #container #main-content-wp #wp-inner .filter-wp .form-filter select option').click(function(){
        alert(1);
    })
    //  SLIDER
